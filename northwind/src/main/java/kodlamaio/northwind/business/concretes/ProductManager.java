...
public class ProductManager implements ProductService {
	...
	public DataResult<List<Product>> getByCategoryIn(List<Integer> categoryId) {
		return new SuccesDataResult<List<Product>>(this.productDao.getByCategory_CategoryIdIn(categoryId),"Data listelendi");
	}
	@Override
	...
	public DataResult<List<Product>> getByNameAndCategory(String productName, int categoryId) {
		return new SuccesDataResult<List<Product>>(this.productDao.getByNameAndCategory_CategoryId(productName,categoryId),"Data listelendi");
	}
	@Override
